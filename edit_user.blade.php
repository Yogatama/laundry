                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="nama" class="form-control" name="nama" placeholder="Nama" type="text" value="{{ $user->nama }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="password" class="form-control" name="password" placeholder="Password" type="password" value="{{ $user->password }}">
                                    <div class="text-danger">
                                        @error('password')
                                                {{ $message }}
                                        @enderror
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="address" class="form-control" name="address" placeholder="Alamat" type="text" value="{{ $user->address }}">
                                    <div class="text-danger">
                                        @error('address')
                                                {{ $message }}
                                        @enderror
